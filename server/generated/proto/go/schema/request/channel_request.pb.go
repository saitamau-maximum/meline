...
func (x *GetChannelByIDRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *JoinChannelRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CreateChildChannelRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *LeaveChannelRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_schema_request_channel_request_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x22, 0x24, 0x0a, 0x12, 0x4a, 0x6f, 0x69, 0x6e,
	...
	0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x42, 0xbb, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x73,
